...
export const FIELD_AUDIT = {
  ...
  deal: {
    ...
    fields: [
      ...
      { id: "hiro_date",       label: "HIRO Date",                          weight: 3, locked: false, definition: "Date the deal entered the stage that converts at ≥25%. Date-stamped via workflow.", example: "—", note: "Pick the HIRO stage based on actual stage-level conversion rates", consequence: "Without HIRO Date, you can't compute Stage 1 → Won probability — your Pipeline Coverage is directional only, not a forecast." },
